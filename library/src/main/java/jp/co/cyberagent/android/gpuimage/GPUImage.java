...
public class GPUImage {
    ...
    public void setCallback(LoadImageCallback callback) {
    ...
    private abstract class LoadImageTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap) {
            ...
            Bitmap background = Bitmap.createBitmap(outputWidth, outputHeight, Bitmap.Config.ARGB_8888);
            ...
            float scale = outputWidth / originalWidth;

            float xTranslation = 0.0f;
            float yTranslation = (outputHeight - originalHeight * scale) / 2.0f;
